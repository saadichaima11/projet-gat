    ...
    <nav class="nav">
        <div> 
          <a href="index.php" class="nav_logo"> 
            ...
            <span class="nav_logo-name">ProfilAppli</span> </a>
            <div class="nav_list"> 
              <a href="application.php" class="nav_link active"> 
                <i class='bx bx-grid-alt nav_icon'></i>
                 <span class="nav_name">Application</span> </a> 
...
<style>
  @import url("https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap");
      :root{
        ...
        body{
          position: relative;margin: var(--header-height) 0 0 0;
        ...
        @media screen and (min-width: 768px){
          body{margin: calc(var(--header-height) + 1rem) 0 0 0;
            ...
            .header{height: calc(var(--header-height) + 1rem);
              ...
              .header_img{width: 70px;height: 40px}
