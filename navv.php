...
<a href="main.php"> 
    ...
    <svg  class="xx" xmlns="http://www.w3.org/2000/svg" width="100" height="100"  fill = "#fff"  viewBox="0 0 16 16">
  ...
  <div class="pie pie2" onclick="document.body.classList.remove('active')">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="#fff" class="discount" viewBox="0 0 16 16">
  ...
  <div class="pie pie3" onclick="document.body.classList.remove('active')">
    <div class="pie-color pie-color3">
      <svg class="cart" viewBox="0 0 20 20"  width="100" height="100">

       
        <path 
        fill="#fff"

        d="M3 10v11h6v-7h6v7h6v-11L12,3z"> </path>
